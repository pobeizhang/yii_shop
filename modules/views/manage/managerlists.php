                ...
                <div id="pad-wrapper" class="users-list">
                    <div class="row-fluid header">
                        ...
                        <div class="span10 pull-right">
                            <a href="<?php echo yii\helpers\Url::to(['manage/addmanager']); ?>" class="btn-flat success pull-right">
                    ...
                    <div class="row-fluid table">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th class="span2" style="width:70px">管理员ID</th>
                                    <th class="span2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('Y-m-d H:i:s',$manager['created_time'])?></td>
                                    <td class="align-right">
                                        <a href="<?php echo yii\helpers\Url::to(['manage/delmanager', 'adminid' => $manager['id']]); ?>">删除</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
