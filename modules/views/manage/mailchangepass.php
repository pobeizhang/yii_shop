            ...
            <?php $form = ActiveForm::begin([
                ...
                <div class="span4 box">
                    <div class="content-wrap">
                        ...
                        <?php echo $form->field($model,'adminpwd')->passwordInput(['class' => 'span12','placeholder' => '管理员新密码']);?>
                        <?php echo $form->field($model,'repwd')->passwordInput(['class' => 'span12','placeholder' => '确认密码密码']);?>
