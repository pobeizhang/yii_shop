    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                	<li><a href="<?php echo yii\helpers\Url::to(['manage/managerlists']);?>">管理员列表</a></li>
                	<li><a href="<?php echo yii\helpers\Url::to(['manage/addmanager']);?>">加入新管理员</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="submenu">
                	<li><a href="<?php echo yii\helpers\Url::to(['user/userlists']);?>">会员列表</a></li>
                	<li><a href="<?php echo yii\helpers\Url::to(['user/adduser']);?>">加入新会员</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                	<li><a href="<?php echo yii\helpers\Url::to(['category/categorylists'])?>">分类列表</a></li>
                	<li><a href="<?php echo yii\helpers\Url::to(['category/addcategory'])?>">加入分类</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                	<li><a href="<?php echo yii\helpers\Url::to(['product/productlist']);?>">商品列表</a></li>
                	<li><a href="<?php echo yii\helpers\Url::to(['product/addproduct']);?>">添加商品</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
...
<script src="/assets/admin/js/jquery-latest.js"></script>
    ...
    <script type="text/javascript">
        ...
        $("#addpic").click(function(){
            var pic = $("#home_product-pics").clone();
            pic.attr("style", "margin-left:120px");
            $("#home_product-pics").parent().append(pic);
        });
