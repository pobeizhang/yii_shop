            ...
            <section id="your-order">
                ...
                <?php ActiveForm::begin([
                    ...
                    <div class="row no-margin order-item">
                        ...
                        <a href="#" class="qty"><?= $product['productnum']?> x</a>
                        </div>

                        <div class="col-xs-12 col-sm-9 ">
                            <div class="title">
                                <a href = '<?= yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]);?>' class = 'thumb-holder'>
                                    <img class = 'lazy' src = '<?= $product['cover']?>-coversmall' />
                                </a>
                                <a style = 'margin-left:50px' href="<?= yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]);?>"><?= $product['title']?></a>
                            </div>
                        </div>
                ...
                <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                    <div id="subtotal-holder">
                        <ul class="tabled-data inverse-bold no-border">
                            <li>
                                <label>商品总价</label>
                                <div style="width:100%;text-align:right" class="value ">$<span id = "productTotalPrice"><?= $total;?></span></div>
                            </li>
                            <li>
                                <label>选择快递</label>
                                <div style="width:100%;text-align:right" class="value">
                                    ...
                                    <input class="le-radio express" type="radio" name="expressid" value="<?= $k?>" data = '<?= $expressPrice[$k]?>' <?= $checked?> /> <div class="radio-label bold"><?= $e;?><span class="bold"> $<?= $expressPrice[$k]?></span></div><br>
                                    <?php endforeach;?>
                                     </div>
                                </div>
                            </li>
                        ...
                        <ul id="total-field" class="tabled-data inverse-bold ">
                            <li>
                                <label>订单总额</label>
                                <div class="value" style="width:100%;text-align:right">$<span id = "orderTotalPrice"><?= $total + $expressPrice[2];?></span></div>
                            </li>
                        </ul><!-- /.tabled-data -->
...
<!-- ========================================= CONTENT : END ========================================= -->		<!-- ============================================================= FOOTER ============================================================= -->
<input type = 'hidden' value = '<?= (int)\Yii::$app->request->get("orderid")?>' name = 'orderid' />
<?php ActiveForm::end();?>
<script>
...
for(var i=0;i<2;i++){
    ...
    if(this.checked == true) {
        var expressPrice = this.getAttribute('data');
        orderTotalPrice.innerHTML =parseInt(productTotalPrice.innerHTML) + parseInt(expressPrice);
    }
