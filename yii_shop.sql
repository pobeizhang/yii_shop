...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户点单地址表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_home_cart` VALUES (4,1,1,112.00,2,1473036374);
...
CREATE TABLE `shop_home_order` (
  ...
  `expreddno` varchar(50) NOT NULL DEFAULT '' COMMENT '快递订单单号',
...
INSERT INTO `shop_home_product` VALUES (1,7,'毛衣','毛衣描述',12313,123.00,'http://obzlvnjse.bkt.clouddn.com/57b52d7749dd0','{\"57b52d7771c21\":\"http:\\/\\/obzlvnjse.bkt.clouddn.com\\/57b52d7771c21\",\"57b52d778e2f9\":\"http:\\/\\/obzlvnjse.bkt.clouddn.com\\/57b52d778e2f9\",\"57b52d77af1d3\":\"http:\\/\\/obzlvnjse.bkt.clouddn.com\\/57b52d77af1d3\"}','1',112.00,'1','1','1',0),(3,4,'AppleMacBook Pro','<h1>Apple MacBook Pro 15.4英寸笔记本电脑 银色(Core i7 处理器/16GB内存/512GB SSD闪存/Retina屏 MJLT2CH)</h1>',500,16999.00,'http://obzlvnjse.bkt.clouddn.com/57c8ec348f477','{\"57c8ec34ac2b8\":\"http:\\/\\/obzlvnjse.bkt.clouddn.com\\/57c8ec34ac2b8\",\"57c8ec34cb45b\":\"http:\\/\\/obzlvnjse.bkt.clouddn.com\\/57c8ec34cb45b\"}','0',16999.00,'1','1','1',0);
...
CREATE TABLE `shop_home_user` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='前台会员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_home_user` VALUES (1,'dulei','2b5960e1e619230bfc08a1015e2a85a3','dulei1618@163.com',1470476608),(2,'zhangyingying','89db097b8717a73fcd6893edd9a7a111','13264038896@163.com',1470476636),(5,'wangwu','7fef6171469e80d32c0559f88b377245','wangwu@test.com',1470535698),(7,'zhaoliu','7fef6171469e80d32c0559f88b377245','zhaoliu@test.com',1470536130),(15,'test','7fef6171469e80d32c0559f88b377245','test@test.com',1470555172),(17,'yii_shop57a6f16a83b10','10f3935b49a6e27b34f4d0e0aeca2be1','1620202112@qq.com',1470558572),(18,'test123','7fef6171469e80d32c0559f88b377245','test123@test.com',1470737273);
...
-- Dump completed on 2016-09-05 19:44:25
